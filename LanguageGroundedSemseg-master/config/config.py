...
opt_arg.add_argument('--iter_size', type=int, default=32, help='accumulate gradient')
...
data_arg.add_argument('--effective_batch_size', type=int, default=32)
...
data_arg.add_argument('--train_limit_numpoints', type=int, default=1200000)
...
test_arg.add_argument('--save_pred_dir', type=str, default='output/pred')
