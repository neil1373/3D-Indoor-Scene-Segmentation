...
class Res16UNetBase(ResNetBase):
    ...
    def network_initialization(self, in_channels, out_channels, config, D):
        ...
        self.bn0 = get_norm(self.NORM_TYPE, self.inplanes,
        ...
        self.conv1p1s2 = conv(
            ...
            conv_type=self.NON_BLOCK_CONV_TYPE,
            D=D)
        self.bn1 = get_norm(self.NORM_TYPE, self.inplanes,
                            D, bn_momentum=bn_momentum)
        ...
        self.conv2p2s2 = conv(
            ...
            conv_type=self.NON_BLOCK_CONV_TYPE,
            D=D)
        self.bn2 = get_norm(self.NORM_TYPE, self.inplanes,
                            D, bn_momentum=bn_momentum)
        ...
        self.conv3p4s2 = conv(
            ...
            conv_type=self.NON_BLOCK_CONV_TYPE,
            D=D)
        self.bn3 = get_norm(self.NORM_TYPE, self.inplanes,
                            D, bn_momentum=bn_momentum)
        ...
        self.conv4p8s2 = conv(
            ...
            conv_type=self.NON_BLOCK_CONV_TYPE,
            D=D)
        self.bn4 = get_norm(self.NORM_TYPE, self.inplanes,
                            D, bn_momentum=bn_momentum)
        ...
        self.final = conv(self.PLANES[7], out_channels,
                          kernel_size=1, stride=1, bias=True, D=D)
