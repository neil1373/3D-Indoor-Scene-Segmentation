...
class SparseVoxelizer:
    ...
    def voxelize(self,
        ...
        if labels is not None:
            coords_aug, feats, labels, _, inverse_map = ME.utils.sparse_quantize(
        ...
        return_args = [coords_aug, feats, labels, inverse_map]

        # for instance augmentation from LGround
        if return_transformation:
            # return_args.append(rigid_transformation.flatten())
            return_args.append((M_v, M_r))
