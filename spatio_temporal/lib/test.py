...
def print_info(iteration,
    ...
    debug_str += "Data time: {:.4f}, Iter time: {:.4f}".format(
        data_time, iter_time)
    ...
    if has_gt:
        ...
        debug_str += 'IOU: ' + ' '.join('{:.03f}'.format(i)
                                        for i in ious) + '\n'
        debug_str += 'mAP: ' + ' '.join('{:.03f}'.format(i)
                                        for i in ap_class) + '\n'
        debug_str += 'mAcc: ' + \
            ' '.join('{:.03f}'.format(i) for i in acc) + '\n'
        ...
        for iteration in range(max_iter):
            ...
            if iteration % config.test_stat_freq == 0 and iteration > 0:
                ...
                print_info(
                    ...
                    dataset_frequency_cats=dataset.frequency_organized_cats)
